...
<div style="margin-bottom:10px;"><input type="button" onClick="location.href='/project/add/'" value="Add new"></div>	  
...
<td align="center"><input type="button" value="Edit" onClick="location.href='/project/edit/?id={$project_v.id}'" /></td>
</tr>
{/foreach}
</table>	
