    ...
    <section class="content-header">
     <h1>Overtime request</h1>
      <ol class="breadcrumb">
		...
		<li><a href="/overtime/">Overtime request list</a></li>
      </ol>
    </section>
            ...
            <!-- form start -->
              <div class="box-body">
                  ...
                  <div class="col-sm-6">
					...
					<option value="{$project_v.id}">{$project_v.name}</option>
					{/foreach}
					</select>				  
				  </div>
                </div>
                  ...
                  <div class="col-sm-6"><textarea name="reason" id="reason" style="height:100px;" class="form-control"></textarea></div>
                </div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-9" style="padding:0">
					...
					<td align="center"><input type="checkbox" value="{$staff_v.id}" name="staff_list[]"/></td>
					</tr>
					{/foreach}
					</table>	
				  </div> 	
...
value:'{/literal}{php}echo date("Y/m/d H:i");{/php}{literal}',
step:10,
format:'Y/m/d H:i'
});
