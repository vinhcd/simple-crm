            ...
            <!-- form start -->
              <div class="box-body">
                  ...
                  <div class="col-sm-6">
					...
					<option value="{$staff_v.id}">{$staff_v.id}/{$staff_v.first_name} {$staff_v.last_name}</option>
					{/foreach}
					</select>				  
				  </div>
                </div>
                  ...
                  <div class="col-sm-6"><input autocomplete="off" name="from_date" type="text" id="from_date" class="form-control"></div>
                </div>
				
			   	<div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">To Date</label>
                  <div class="col-sm-6"><input autocomplete="off" name="to_date" type="text" id="to_date" class="form-control"/></div>
				</div>
	
	
			   	<div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Effort</label>
                  <div class="col-sm-6"><input autocomplete="off" name="effort" type="text" id="effort" class="form-control"/></div>
