...
{foreach from=$salary item=salary_v}
	<div class="page">
		...
		<div style="font-size:30px; font-weight:bold;">Bảng  lương chi tiết (T{$current_month}.{$current_year})</div>
...
{literal}
	...
	{else}
	{literal}
		window.location = "/salary/?staff_id={/literal}{$smarty.get.staff_id}{literal}&yearmonth={/literal}{$smarty.get.yearmonth}{literal}";
	{/literal}
	{/if}
	{literal}	
