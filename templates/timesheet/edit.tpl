...
$('#start_time').datetimepicker({
	...
	format:'Y/m/d',
	formatDate:'Y/m/d',
	value:'{/literal}{php}echo date("Y/m/d",strtotime($this->_tpl_vars["woking_time_one"]["check_in"])); {/php}{literal}'
});
...
$('#finish_time').datetimepicker({
	...
	format:'Y/m/d',
	formatDate:'Y/m/d',
	value:'{/literal}{php}echo date("Y/m/d",strtotime($this->_tpl_vars["woking_time_one"]["check_out"])); {/php}{literal}'});
