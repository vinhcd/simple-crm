...
return [
    UserServiceProvider::MODULE_NAME => [
        ...
        \App\Module\User\Api\Data\PositionInterface::class => \App\Module\User\Models\Data\Position::class,
        ...
        \App\Module\User\Api\PositionRepositoryInterface::class => \App\Module\User\Models\PositionRepository::class,
